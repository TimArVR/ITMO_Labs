...
//опорный элемент дл€ QuickSort, медиана первого, среднего и последнего элемента сортируемого интервала
...
// –азбиение ’оара на две части относительно pivot
template<typename T, typename Compare>
...
// Ѕыстра€ сортировка на основе разделени€ ’оара
template<typename T, typename Compare>
...
// ќптимизированна€ сортировка, если больше порога, то быстра€ сортировка, если меньше порога - вставками.
template<typename T, typename Compare>
void sort(T* first, T* last, Compare comp)
{
	...
	InsertionSort(first, last, comp); //если меньше порога, т.к. вставка работает быстрее за счет экономии на вспомогательных действи€х небольших наборов данных
}
